...
async function main() {
  ...
  const products: Array<{
    ...
    { slug: "tig-200-ac-dc", name: "PrecisionArc 200 AC/DC TIG Welder", cat: "tig-welders", brand: "PrecisionArc", price: 159900, stock: 8, img: "https://images.unsplash.com/photo-1587293852726-70cdb56c2866?w=800", desc: "Inverter AC/DC TIG with pulse and HF start, ideal for aluminum and stainless work.", supplierId: supplier.id, featured: true },
    ...
    { slug: "multiprocess-220", name: "Multimaster 220 Multi-Process Welder", cat: "multi-process", brand: "Multimaster", price: 184900, stock: 6, img: "https://images.unsplash.com/photo-1537462715879-360eeb61a0ad?w=800", desc: "MIG/TIG/Stick in one unit. Dual voltage, synergic control, spool gun ready.", supplierId: supplier.id, featured: true },
    { slug: "plasma-45-cnc", name: "PlazCut 45 CNC-Ready Plasma Cutter", cat: "plasma-cutters", brand: "PlazCut", price: 139900, stock: 5, img: "https://images.unsplash.com/photo-1516216628859-9bccecab13ca?w=800", desc: "45A plasma cutter with CNC port, 5/8\" cutting capacity, drag-cut tip included.", supplierId: supplier.id },
    ...
    { slug: "stick-7018-50lb", name: "E7018 Stick Electrodes 1/8\" — 50 lb", cat: "stick-electrodes", brand: "WeldCore", price: 16800, stock: 35, img: "https://images.unsplash.com/photo-1469289759076-d1484757abc3?w=800", desc: "Low-hydrogen 7018 electrodes, vac-pak sealed, for structural and pressure work.", supplierId: supplier.id },
    ...
    { slug: "mig-stick-jacket", name: "FR Cotton Welding Jacket — 30\"", cat: "jackets", brand: "ForgeGrip", price: 6900, stock: 50, img: "https://images.unsplash.com/photo-1604335399105-a0c585fd81a1?w=800", desc: "Flame-resistant cotton jacket, snap front, multiple pockets.", supplierId: supplier2.id },
    { slug: "half-mask-respirator", name: "Half-Mask Welding Respirator with P100 Cartridges", cat: "respirators", brand: "AirGuard", price: 8900, stock: 60, img: "https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=800", desc: "NIOSH-approved half-mask with P100 filters for welding fume.", supplierId: supplier2.id },
    ...
    { slug: "tig-torch-wp17-25ft", name: 'WP-17 Air-Cooled TIG Torch — 25 ft', cat: "torches", brand: "PrecisionArc", price: 12900, stock: 18, img: "https://images.unsplash.com/photo-1587293852726-70cdb56c2866?w=800", desc: "WP-17 style TIG torch with 25 ft cable and accessory kit.", supplierId: supplier.id },
    ...
    { slug: "grinding-wheel-45-25pk", name: '4-1/2" Grinding Wheel 1/4" — 25 pk', cat: "grinding-wheels", brand: "ForgeGrip", price: 4900, stock: 80, img: "https://images.unsplash.com/photo-1587293852726-70cdb56c2866?w=800", desc: 'Type 27 metal grinding wheels, 4-1/2" x 1/4" x 7/8", case of 25.', supplierId: supplier2.id },
    { slug: "cutoff-wheel-45-50pk", name: '4-1/2" Cut-Off Wheel 0.045" — 50 pk', cat: "cutoff-wheels", brand: "ForgeGrip", price: 5900, stock: 90, img: "https://images.unsplash.com/photo-1537462715879-360eeb61a0ad?w=800", desc: 'Thin cut-off wheels for steel and stainless, 50-pack value bulk.', supplierId: supplier2.id },
    { slug: "flap-disc-40g-10pk", name: '4-1/2" Flap Disc 40-Grit — 10 pk', cat: "flap-discs", brand: "ForgeGrip", price: 3200, stock: 110, img: "https://images.unsplash.com/photo-1469289759076-d1484757abc3?w=800", desc: "Zirconia flap discs for aggressive metal removal, 10-pack.", supplierId: supplier2.id },
  ];
